"""
Pydantic configuration schema for Nadir.
...
class ProjectConfig(BaseModel):
    ...
    name: str = Field(default="Nadir", description="Project name")
    run_id: str = Field(
...
class NadirConfig(BaseModel):
    """Root configuration model for Nadir."""
