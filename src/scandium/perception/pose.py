...
class PoseEstimator:
    ...
    def __init__(self, marker_size_m: float = 0.2, solve_method: int = 0, dt: float = 0.033) -> None:
        ...
        try:
            ...
            self._ekf = scandium_ekf.ExtendedKalmanFilter(self._dt, 0.5, 0.05)
            ...
            import logging
            logging.getLogger(__name__).warning("C++ scandium_ekf module not found. Falling back to raw solvePnP. Run scripts/build_cpp.sh")
